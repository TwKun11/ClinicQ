    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/v1/admin/doctors/*/slots").hasRole("ADMIN")
                        .requestMatchers(HttpMethod.PUT, "/api/v1/admin/slots/*/block").hasRole("ADMIN")
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/v1/appointments/*/cancel").hasRole("USER")
